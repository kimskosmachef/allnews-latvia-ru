...
NIGHT_NEWS_MAX_AGE_MINUTES = 70    # за какой период брать новости ночью (минуты)
...
# Фильтрация по рубрикам (для tvnet и похожих сайтов)
# Бот загружает заголовки из указанных рубрик и не публикует совпадающие новости
# Блок "Читаемые" на tvnet автоматически игнорируется
SECTION_FILTERS = {
    "RUS TVNET": [
        "https://rus.tvnet.lv/section/4368",  # За рубежом
        # Добавляй другие рубрики по образцу:
        # "https://rus.tvnet.lv/section/4371",  # Спорт
    ],
}