...
# За какой период брать новости (в минутах)
# Должно быть равно или чуть больше CHECK_INTERVAL_MINUTES
# чтобы не было пропусков между проверками
NEWS_MAX_AGE_MINUTES = 15

# Настройки работы в ночом режиме
NIGHT_MODE_START = 1               # с 01:00
NIGHT_MODE_END = 7                 # до 07:00
NIGHT_CHECK_INTERVAL_MINUTES = 60  # проверка раз в час
NIGHT_NEWS_MAX_AGE_MINUTES = 70    # за последние 70 минут
